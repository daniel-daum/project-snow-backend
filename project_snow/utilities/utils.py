...
def send_verification_email(db: Session, token: str, user: schemas.User):
    ...
    <p>This email was sent to: {user.email.upper()}
        ...
        Project Snow will never contact you by email asking you to validate your personal information such as your password. If you recieve such a request please contact us at <span style="text-decoration: underline ;">labfull@proton.me</span></p>
    </body>
    </html>
    ''', subtype='html')
